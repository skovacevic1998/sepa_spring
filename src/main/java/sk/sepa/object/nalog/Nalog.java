...
public class Nalog {
    ...
    private Long id;
    private Long id_grupe_naloga;
    private Long id_user;
    private Long id_banke;
    private String tip_naloga;
    private String valuta_placanja;
    private BigDecimal iznos;
    private String ime_plat;
    private String adresa_plat;
    private String mjesto_plat;
    private String ime_prim;
    private String adresa_prim;
    private String mjesto_prim;
    int sif_opis_plac;
    private String sif_namjene;
    private Date dat_izvrsenja;
    private Date dat_podnosenja;
    private String drzava_plat;
    private String kontrolni_broj_plat;
    private String iban_plat;
    private String model_plat;
    private String pnb_plat;
    private String drzava_prim;
    private String kontrolni_broj_prim;
    private String iban_prim;
    private String model_prim;
    private String pnb_prim;
    private String opis_plac;
    private int br_blagajne;
    private int vr_naknade;
    private BigDecimal iznos_naknade;
    private String sts_naloga;
